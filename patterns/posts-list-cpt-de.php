...
?>
   ...
   ;?>
    ...
    <div class="wp-block-query alignwide">
      <!-- wp:query-no-results -->
      <!-- wp:paragraph -->
      <p><?php echo esc_html_x( 'Es wurde kein Inhalt gefunden', 'No results text of the Posts list CPT pattern', 'blockhaus' ); ?></p>
      <!-- /wp:paragraph -->
      <!-- /wp:query-no-results -->
...
<!-- wp:read-more {"content":"<?php echo esc_html_x( 'Mehr lesen', 'Read more text of the Posts list CPT pattern', 'blockhaus' ); ?>","className":"is-style-button"} /-->
</div>
<!-- /wp:group --></div>
<!-- /wp:group -->
        <!-- /wp:post-template -->
