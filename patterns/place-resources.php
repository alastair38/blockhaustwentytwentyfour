...
<div class="wp-block-group alignwide is-style-default">
  ...
  <h2 class="wp-block-heading has-large-font-size" style="font-style:normal;font-weight:900">
    <?php echo esc_html_x( 'Resources', 'Title text of the Place Resources section', 'blockhaus' ); ?>
  </h2>
  <!-- /wp:heading -->
  ...
  <div class="wp-block-query">
    <!-- wp:post-template {"style":{"spacing":{"blockGap":"0"}},"className":"is-style-grid-template","layout":{"type":"default","columnCount":3}} -->
      ...
      <div class="wp-block-group is-style-shadow-group has-base-2-background-color has-background" style="min-height:100%">
      
        <!-- wp:group {"layout":{"type":"default"}} -->
        <div class="wp-block-group">
          <!-- wp:post-title {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"medium"} /-->
    ...
    <p>
      <?php echo esc_html_x( 'We are regularly adding content. Please check back soon.', 'No results text of the Place Resources section', 'blockhaus' ); ?>
    </p>
    <!-- /wp:paragraph -->
    <!-- /wp:query-no-results -->
