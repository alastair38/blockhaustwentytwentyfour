...
<div class="wp-block-group alignfull is-style-default"><!-- wp:image {"align":"center","id":2007,"sizeSlug":"medium","linkDestination":"none"} -->
<figure class="wp-block-image aligncenter size-medium"><img src="http://demproj.local/wp-content/uploads/2023/12/Isometric-Stickers-Brainstorming-300x187.png" alt="" class="wp-image-2007"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">View all our outputs</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->